...
|--------|-------------|--------------|
| [🔒 Network Segmentation Lab]<a href="https://github.com/AnthonyStaneart/network-segmentation-pfsense/blob/main/README.md">View Lab</a> | Segmented a home network using pfSense into LAN/DMZ/Guest and enforced access control. Includes Nmap & Wireshark validation. | pfSense, Nmap, Wireshark |
